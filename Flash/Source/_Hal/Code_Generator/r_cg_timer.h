...
#define _9C3F_TAU_TDR10_VALUE                   (0x9C3FU)
/* 16-bit timer data register 11 (TDR11) */
#define _4E20_TAU_TDR11_VALUE                   (0x4E20U)
/* Clock divisor for TAU1 channel 0 */
#define _0008_TAU1_CHANNEL0_DIVISOR             (0x0008U)
/* Clock divisor for TAU1 channel 1 */
#define _0008_TAU1_CHANNEL1_DIVISOR             (0x0008U)
