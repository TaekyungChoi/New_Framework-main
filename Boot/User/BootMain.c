...
U16 gu16BootModuleInitCnt = 100;	// 1sec. 모듈 전원/리셋핀 제어를 위한 카운트
U16 gu16BootInitTimeoutCnt = 6000; // 1min.
U8 gu8BootModuleInit_F;
U8 gu8BootFailCnt; 
 
extern U16 gu16BootModuleRxCheck; 
extern U8 gu8BootAuConValue;
extern U8 gu8BootEndResultCode;
...
void BOOT_R_TAU0_Channel0_Start(void)
{
...
void BOOT_FotaLEDControl(void)	
{
	static U16 mu16FotaLEDCnt = 0; 
	mu16FotaLEDCnt++;	
...
static U8 BOOT_initModulePort(void)
{
...
static U8 BOOT_checkOTARequestCondition(U8* mu8RxData)
{
...
static U8 BOOT_checkOldBootErase(U8* mu8RxData)
{
	BOOT_FDLReadByte(DATAFLASH_ADDR_OTASTATUS, mu8RxData, 3);
...
void BOOT_setOTARequest(void)
{
	U8 mu8Var[3] = {0x77, 0x88, 0x99};
...
{	
	...
	U8 mu8RxData; 
	U8 mu8RxDataSaved;
	U8 mu8DeviceReady = BOOT_RX_NONE;
	U8 mu8BootState = 0x00;  
