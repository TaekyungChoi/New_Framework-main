...
U8 gu8BootMsgBuffer[291];
static U16 gu16RxBinCRC;
U16 gu16BootModuleRxCheck = BOOT_RxCheckTime;
U16 gu16BootPacketCnt;
U8 gu8BootEndResultCode;
U8 gu8BootAuConValue; 

extern U8 gu8BootFailCnt;
...
{
	static U8 mu8Command;
	static U32 mu32WriteAddressIndex = START_WRITEADDR;
	fsl_write_t msWriteBuff;
	static U16 mu16index;
	U16 mu16RxCRC;
	static U16 mu16BlockCnt = START_WRITEBLOCK; 
	static U8 mu8VerifyCnt = 0;
	U16 mu16IndexValue = 0; 
...
{
	U8 mu8index;
	static U8 mu8STXRx_F = 0;
	static U16 mu16index = 0;
	static U16 mu16RxLength = 0xFFFD;
	static U8 mu8ParsingDone_F = CLEAR;
	U8 mu8RxData;
